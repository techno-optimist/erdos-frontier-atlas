...
| 🟡 | **#979** `f₃` / A385316 | `a(6) > 10¹²` certified (two independent implementations, C1); a RAM-bounded streaming sweep then covered `[0, 10¹³)` gap-free with no 6-way value — **`a(6) > 10¹³`**, C2 pending independent replication; beats the published `4.99·10¹¹` by 20× | [`certificates/erdos-979`](certificates/erdos-979) | 2026-07-19 |
