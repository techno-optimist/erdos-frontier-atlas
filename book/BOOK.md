...
- Confidence distribution (computed from `evidence[]`, never asserted): **C0** 0 · **C1** 0 · **C2** 8 · **C3** 217.
...
Exact-value attack-state over the gap map's 225 quantities (field `exact_feasibility`):
