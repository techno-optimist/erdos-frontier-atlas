...
## 2026-08-19 — Erdős 142: disjoint graph and total-decoder overlap walls
...
the packet in this total interface. Partial/state-carved alphabets, reachable
dead sinks, nondeterministic ownership, arbitrary measurable overlaps,
infinite-state systems, almost-everywhere coercivity, shelling, integer
transfer, and a new `r_3` bound remain outside scope.
