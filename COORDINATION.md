...
| `automation/frontier-scout-public-recovery-20260822` | Public-safe Foundry receipt projection recovery | progress-only projection receipts, manifest/certificate/index | rebuilding locally; no push/publication |
| *(add your lane)* | | | |
