...
partial deterministic interface with at most six states. Accepted rate means
the Perron root of the reachable/coaccessible live trim; an ambient dead-sink
root is irrelevant. An exact product-first census checks all 2,058,472 strong
S6 orbits, leaves 1,641 product-incomplete cases, and proves their exact rate
split `(below,equal,above)=(1640,1,0)`, with maximum witness horizon 50. The
weighted companion proves exact optimum 1 through dimension 28 and excludes
the gate through dimension 31; its d29/d32 relaxation failures are not
constructions. Seven or more homogeneous states, box-sensitive/state-carved
