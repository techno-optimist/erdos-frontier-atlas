...
| `agent/astra-structural-probes-20260904` | Official-source freshness + bounded structural probes, starting with P993 / P699; no remote publication | `experiments/astra-20260904/` only | complete locally; unpromoted; no remote publication |
| *(add your lane)* | | | |
