...
## 2026-08-19 — Erdős 142: globally disjoint graph-carving wall
...
The general repeated/overlapping-tile case is still open; the parity packet
does not make the graph theorem carving-stable. Infinite-state systems,
almost-everywhere coercivity, shelling, integer transfer, and a new `r_3`
bound are also outside scope.
