#!/usr/bin/env python3
"""Independent verifier: n=8 L=6 S=6 split-weight macro witness."""
...
WIT = json.loads((HERE / "N8_L6_S6_WITNESS.json").read_text(encoding="utf-8"))
OUT = HERE / "N8_L6_S6_MACRO_WITNESS_RESULT.json"
...
def main():
    ...
    status = (
        "PASS_N8_L6_S6_SPLIT_MACRO_WITNESS"
        if flow_ok and tags_ok and connected and parikh_ok
        else "FAIL"
    )
    result = {
        "schema": "lead.n8_l6_s6_macro_witness.v1",
        "status": status,
        "state_count": S,
        "return_length": L,
        "n": N,
        ...
        "claim_boundary": (
            "Exact n=8 common-anchor split-weight length-six Parikh-balanced "
