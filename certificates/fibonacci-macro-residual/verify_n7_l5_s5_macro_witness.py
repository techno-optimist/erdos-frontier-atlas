#!/usr/bin/env python3
"""
Independent exact verifier for n=7 L=5 S=5 split-weight macro witness.
"""
...
WIT = json.loads((HERE / "N7_L5_S5_WITNESS.json").read_text(encoding="utf-8"))
OUT = HERE / "N7_L5_S5_MACRO_WITNESS_RESULT.json"
...
def main():
    ...
    result = {
        "schema": "lead.n7_l5_s5_macro_witness.v1",
        "status": status,
        "state_count": S,
        "return_length": L,
        "n": N,
        ...
        "claim_boundary": (
            "Exact n=7 common-anchor split-weight length-five globally "
            "Parikh-balanced macro on a 5-state deterministic ternary clock. "
            "Not an Erdős 142 construction."
        ),
    }
