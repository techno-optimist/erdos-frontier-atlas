#!/usr/bin/env python3
"""Independent verifier: n=9 L=7 S=7 split-weight macro witness."""
...
WIT = json.loads((HERE / "N9_L7_S7_WITNESS.json").read_text(encoding="utf-8"))
OUT = HERE / "N9_L7_S7_MACRO_WITNESS_RESULT.json"
...
def main():
    ...
    status = (
        "PASS_N9_L7_S7_SPLIT_MACRO_WITNESS"
        if flow_ok and tags_ok and seen == used and parikh_ok
        else "FAIL"
    )
    result = {
        "schema": "lead.n9_l7_s7_macro_witness.v1",
        "status": status,
        "n": N,
        "L": L,
        "S": S,
        ...
        "weakly_connected_from_anchor": seen == used,
        "claim_boundary": "Exact n=9 L=7 S=7 common-anchor Parikh macro. Not E142.",
    }
