#!/usr/bin/env python3
"""Independent verifier: n=9 L=6 S=6 split-weight macro witness."""
...
WIT = json.loads((HERE / "N9_L6_S6_WITNESS.json").read_text(encoding="utf-8"))
OUT = HERE / "N9_L6_S6_MACRO_WITNESS_RESULT.json"
...
def main():
    ...
    status = (
        "PASS_N9_L6_S6_SPLIT_MACRO_WITNESS"
        if flow_ok and tags_ok and connected and parikh_ok
        else "FAIL"
    )
    result = {
        "schema": "lead.n9_l6_s6_macro_witness.v1",
        "status": status,
        "state_count": S,
        "return_length": L,
        "n": N,
        ...
        "claim_boundary": (
            "Exact n=9 common-anchor split-weight length-six Parikh-balanced "
