#!/usr/bin/env python3
"""Independent verifier: n=11 L=7 S=7 split-weight macro witness."""
...
WIT = json.loads((HERE / "N11_L7_S7_WITNESS.json").read_text(encoding="utf-8"))
OUT = HERE / "N11_L7_S7_MACRO_WITNESS_RESULT.json"
...
def main():
    ...
    status = (
        "PASS_N11_L7_S7_SPLIT_MACRO_WITNESS"
        if flow_ok and tags_ok and connected and parikh_ok
        else "FAIL"
    )
    result = {
        "schema": "lead.n11_l7_s7_macro_witness.v1",
        "status": status,
        "state_count": S,
        "return_length": L,
        "n": N,
        ...
        "claim_boundary": (
            "Exact n=11 common-anchor split-weight length-seven Parikh-balanced "
