#!/usr/bin/env python3
"""
Independent exact verifier for n=6 L=4 S=5 split-weight macro witness.
...
WIT = json.loads((HERE / "N6_L4_S5_WITNESS.json").read_text(encoding="utf-8"))
OUT = HERE / "N6_L4_S5_MACRO_WITNESS_RESULT.json"
...
def main():
    ...
    result = {
        "schema": "lead.n6_l4_s5_macro_witness.v1",
        "status": status,
        "state_count": S,
        "return_length": L,
        "n": N,
        ...
        "claim_boundary": (
            "Exact n=6 common-anchor split-weight length-four globally "
